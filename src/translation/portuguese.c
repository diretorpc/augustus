...
static translation_string all_strings[] = {
   {TR_NO_PATCH_TITLE, "Atualização 1.0.1.0 não instalada"},
    ...
    {TR_BUILDING_CARAVANSERAI_POLICY_3, "Política das capacidades terrestres: caravanas terrestres transportam 10 unidades adicionais de mercadorias, mas consomem 20% mais comida no Caravançará." },
    ...
    {TR_BUILDING_LIGHTHOUSE_POLICY_3, "Política das quantidades marítimas: navios transportam 10 unidades adicionais de mercadorias, mas o Farol consome 20% mais madeira." },
